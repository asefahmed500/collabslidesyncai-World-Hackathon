        ...
        <div className="space-y-3">
          {slides.map((slide, index) => {
            ...
            if (slide.backgroundGradient) {
              ...
              if (type === 'linear') {
                backgroundStyle.backgroundImage = `linear-gradient(${angle || 0}deg, ${startColor}, ${endColor})`;
              } else if (type === 'radial') {
                backgroundStyle.backgroundImage = `radial-gradient(circle, ${startColor}, ${endColor})`;
              }
            } else if (slide.backgroundImageUrl) {
              backgroundStyle.backgroundImage = `url(${slide.backgroundImageUrl})`;
            ...
            return (
              ...
              >
                ...
                >
                  {/* Only show placeholder image if no background image OR gradient is set */}
                  {!slide.backgroundImageUrl && !slide.backgroundGradient && ( 
                    <Image

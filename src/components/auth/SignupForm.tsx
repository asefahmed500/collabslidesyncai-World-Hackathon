...
export function SignupForm() {
  ...
  useEffect(() => {
    if (formState.message) {
      if (formState.success) {
        ...
        // Maybe redirect to a "please verify your email page" or login page with a message.
        // For now, just clear form and let them know.
        form.reset(); 
        // setTimeout(() => {
        //   router.push("/login"); 
        //   router.refresh();
  ...
  // const handleGitHubSignup = () => socialLogin(new GithubAuthProvider()); // Can be enabled later

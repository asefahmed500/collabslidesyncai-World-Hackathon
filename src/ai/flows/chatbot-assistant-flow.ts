 ...
 *
 * - chatbotAssistant - A function that handles chat interactions.
 * - ChatbotAssistantInput - The input type for the chatbotAssistantFlow function.
 * - ChatbotAssistantOutput - The return type for the chatbotAssistantFlow function.
 */
